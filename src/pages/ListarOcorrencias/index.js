...
const url = 'http://10.0.0.124:8080/ocorrenciasemexecucao/2';

export default function ListarOcorrencias({navigation, route}) {
    ...
    return(
      <CustomFundo>
            ...
            <Card style={{marginTop: 70, padding:20, marginBottom:190}}>
                <Text style={styles.title}>OCORRÊNCIAS EM EXECUÇÃO</Text>
                        ...
                        renderItem = {({item}) => (
                          <TouchableOpacity 
                            ...
                            onPress={() => {
                              ...
                              navigation.navigate('VerOcorrencia', {
                                itemId: item.id,
                                userId
                              });
